...
public class ServerConfig {
    public static ServerConfigOption load(String tomlConfigFile) throws ConfigException {
     ...
     */
    public static ServerConfigOption load(String tomlConfigFile, int cryptoType)
        ...
        try {
            ...
            ServerConfigOption configOption = new ServerConfigOption(configProperty, cryptoType);
            return configOption;
        } catch (Exception e) {
